    ...
    try {
        const response = await hubspotClient.crm.tickets.basicApi.create({
            properties: {
                ...
                jitbit_updated_for_tech_view: jitbitTicket.UpdatedForTechView.toString(),
                ...
                jitbit_last_updated_by_user_id: (jitbitTicket.LastUpdatedByUserID || "").toString(),
                jitbit_last_updated_username: jitbitTicket.LastUpdatedUsername || "",
                jitbit_start_date: formatHubSpotDate(jitbitTicket.StartDate),
                jitbit_time_spent_in_seconds: jitbitTicket.TimeSpentInSeconds.toString(),
...
export { syncCompany, syncContact, syncTicket ,runSync};